...
insert  into `menus`(`id_menu`,`menu`,`submenu`,`titulo`,`url`,`orden`,`subsubmenu`,`estado`) values (3,'Modulo de Administracion','Roles','Roles','./administrar-roles.php',4,0,1),(4,'Modulo de Administracion','Accesos segun Roles','Accesos segun Roles','./menus-por-roles.php',5,0,1),(7,'Modulo de Administracion','Usuarios','Usuarios','./administrar-usuarios.php',8,0,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=191 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Usuarios del sistema';

/*Data for the table `usuarios` */

insert  into `usuarios`(`id_usuario`,`nombre_usuario`,`nombre`,`apellido`,`password`,`fecha_registro`,`estado`,`rol`) values (1,'admin','admin','admin','202cb962ac59075b964b07152d234b70','2016-08-14 23:50:02',1,1),(190,'prueba','Fabian','Fabian','202cb962ac59075b964b07152d234b70','2021-08-21 19:58:42',1,5);
