...
insert  into `backlogs`(`id_backlog`,`nombre`,`id_proyecto`,`estado`) values (1,'Back1',7,'Abierto'),(4,'bakc2',6,'Abierto');
...
insert  into `proyectos`(`id_proyecto`,`nombre`,`estado`,`fecha_registro`) values (6,'Prueba','Abierto','2021-09-25 21:16:30'),(7,'prueba 2','Abierto','2021-09-26 21:20:13'),(8,'prueba 3','Abierto','2021-10-21 21:42:22');
...
insert  into `relaciones_usuarios`(`id_relacion_usuario`,`id_proyecto`,`id_usuario`) values (9,6,192),(10,7,191),(11,8,190);
...
insert  into `user_stories`(`id_user_storie`,`id_backlog`,`id_usuario`,`descripcion`,`fecha`) values (1,1,191,'prueba user storie','2021-10-21 21:06:15');
...
) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Usuarios del sistema';

/*Data for the table `usuarios` */

insert  into `usuarios`(`id_usuario`,`id_proyecto`,`nombre_usuario`,`nombre`,`apellido`,`password`,`fecha_registro`,`estado`,`rol`) values (1,0,'admin','admin','admin','202cb962ac59075b964b07152d234b70','2016-08-14 23:50:02',1,1),(190,8,'prueba','Fabian','Fabian','202cb962ac59075b964b07152d234b70','2021-08-21 19:58:42',1,5),(191,7,'roger','roger','rondelli','202cb962ac59075b964b07152d234b70','2021-09-26 18:57:51',1,6),(192,6,'enrique','enrique','chavez','202cb962ac59075b964b07152d234b70','2021-09-26 18:58:13',1,6);
