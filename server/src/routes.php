...
$app->group('/api', function(\Slim\App $app) {
        ...
        $app->post('/proyecto/list', function(Request $request, Response $response){
            try {
                ...
                $sql = "SELECT u.id_usuario,u.apellido,u.nombre, r.id_proyecto
                        ...
                        LEFT JOIN relaciones_usuarios r ON r.id_usuario = u.id_usuario
                        WHERE u.rol != 1 AND u.id_usuario NOT IN (SELECT id_usuario
                                            FROM relaciones_usuarios) OR r.id_proyecto = $id
                        ORDER BY u.id_usuario ASC";
    ...
    //BACKLOGS
        $app->get('/backlogs/list', function(Request $request, Response $response){
            try {
                ...
                $sql = "SELECT b.nombre,p.nombre as nombre_proyecto,b.estado,b.id_backlog
                        FROM backlogs b
                        JOIN proyectos p ON p.id_backlog = b.id_backlog
                ...
                $sql = "SELECT *
                        FROM proyectos
                        WHERE id_backlog NOT IN (SELECT id_backlog
                                                    FROM backlogs)";
        ...
        $app->post('/backlog/list', function(Request $request, Response $response){
            try {
                ...
                $sql = "SELECT b.nombre,p.nombre as nombre_proyecto,b.estado,b.id_backlog,p.id_proyecto
                        FROM backlogs b
                        JOIN proyectos p ON p.id_backlog = b.id_backlog
                ...
                $sql = "SELECT nombre, id_proyecto
                        FROM proyectos 
                        WHERE id_backlog NOT IN (SELECT id_backlog
                                                    FROM backlogs) OR id_backlog = $id
                        ORDER BY id_proyecto ASC";
        ...
        $app->post('/backlogs/create', function(Request $request, Response $response){
            try {
                ...
                $sql = "INSERT INTO backlogs (nombre, estado) 
                                            VALUES
                                            ('$nombre', '$estado')";
                $stmt = $db->prepare($sql);
                $stmt->execute();
                $id_backlog = $db->lastInsertId();

                $sql = "UPDATE proyectos SET id_backlog='$id_backlog'
                        WHERE id_proyecto='$id_proyecto'";
        ...
        $app->post('/backlogs/edit', function(Request $request, Response $response){
            try {
                ...
                $sql = "UPDATE proyectos SET id_backlog=0
                WHERE id_backlog='$id_backlog'";
    ...
    //USERSTURY
        $app->get('/userstories/list', function(Request $request, Response $response){
            try {
                ...
                $sql = "SELECT us.descripcion, us.id_user_storie, us.titulo, b.nombre, u.nombre as nombre_usuario, u.apellido
        ...
        $app->post('/userstories/create', function(Request $request, Response $response){
            try {
                ...
                $sql = "INSERT INTO user_stories (descripcion, id_backlog, id_usuario, titulo) 
                                            VALUES
                                            ('$descripcion', '$id_backlog', '$id_usuario', '$titulo')";
                $stmt = $db->prepare($sql);
                $stmt->execute();
    ...
    //SPRINTS
        $app->get('/sprints/list', function(Request $request, Response $response){
            try {
                $db = $this->db;
                ...
                $sql = "SELECT *
                        FROM proyectos
                        WHERE id_proyecto NOT IN (SELECT id_proyecto FROM sprints)
                        ORDER BY id_proyecto ASC";

                $proyectos = consulta($db,$sql);
                
                $sql = "SELECT * FROM backlogs";
        ...
        $app->post('/sprints/us', function(Request $request, Response $response){
            try {
                $id = $_POST['id'];
                $db = $this->db;
                $us = [];
        ...
        $app->post('/sprint/list', function(Request $request, Response $response){
            try {
                $id = $_POST['id'];
                $db = $this->db;
                ...
                $sql = "SELECT *
                        FROM proyectos
                        WHERE id_proyecto NOT IN (SELECT id_proyecto FROM sprints) OR id_proyecto = $id_proyecto
                        ORDER BY id_proyecto ASC";
        ...
        $app->post('/sprints/create', function(Request $request, Response $response){
            try {
                $db = $this->db;
                ...
                $sql = "INSERT INTO sprints (id_proyecto, fecha_fin, fecha_inicio) 
                                            VALUES
                                            ('$id_proyecto', '$fecha_fin', '$fecha_inicio')";
                $stmt = $db->prepare($sql);
                $stmt->execute();
        ...
        $app->post('/sprints/edit', function(Request $request, Response $response){
            try {
                $db = $this->db;
                ...
                $sql = "UPDATE sprints SET id_proyecto='$id_proyecto', 
                                        fecha_fin='$fecha_fin'
                ...
                $sql = "DELETE FROM relaciones_us WHERE id_sprint = $id_sprint";
                $stmt = $db->prepare($sql);
                $stmt->execute();
        ...
        $app->post('/sprints/delete', function(Request $request, Response $response){
            try {
                $db = $this->db;
                $id = $_POST['id'];

                $sql = "DELETE FROM sprints WHERE id_sprint = $id";
                $stmt = $db->prepare($sql);
                $stmt->execute();

                $sql = "DELETE FROM relaciones_us WHERE id_sprint='$id'";
                $stmt = $db->prepare($sql);
                $stmt->execute();
        ...
        $app->post('/sprints/comment', function(Request $request, Response $response){
            try {
                $db = $this->db;
                ...
                $sql = "INSERT INTO comentarios (id_sprint, id_usuario, comentario) 
                                            VALUES
                                            ('$id_sprint', '$id_usuario', '$comentario')";
                $stmt = $db->prepare($sql);
                $stmt->execute();
        ...
        $app->post('/sprints/listTableKanban', function(Request $request, Response $response){
            try {        
                $id = $_POST['id'];
                $db = $this->db;

                $sql = "SELECT p.id_backlog,s.estado
                        FROM sprints s
                        JOIN proyectos p ON p.id_proyecto = s.id_proyecto
                        WHERE s.id_sprint = $id 
                        ORDER BY s.id_sprint ASC";

                $id_backlog = consulta($db,$sql);

                $estado = $id_backlog[0]->estado;
                $id_backlog = $id_backlog[0]->id_backlog;

                $sql = "SELECT *
                        FROM user_stories
                        WHERE id_backlog = $id_backlog
                        ORDER BY id_user_storie ASC";
        ...
        $app->post('/sprints/updateStatusKanban', function(Request $request, Response $response){
            try {        
                $id = $_POST['id'];
                $estado = $_POST['estado'];
                $db = $this->db;

                $sql = "UPDATE user_stories SET estado='$estado'
                        WHERE id_user_storie='$id'";
        ...
        $app->post('/sprints/statusSprint', function(Request $request, Response $response){
            try {        
                $id_sprint = $_POST['id'];
                $estado = $_POST['estado'];
                $db = $this->db;

                $sql = "UPDATE sprints SET estado='$estado'
                        WHERE id_sprint='$id_sprint'";
...
function usList($db,$id,$type = null){
    try{
        $WHERE = "WHERE p.id_proyecto = $id AND us.id_user_storie NOT IN (SELECT id_user_storie FROM relaciones_us)";
        $campos = "us.*";
        $relacion = "";
        
        if($type != null){
            $campos = "us.*,r.id_relacion";
            $relacion = "LEFT JOIN relaciones_us r ON r.id_user_storie = us.id_user_storie";
            $WHERE = "WHERE p.id_proyecto = $id";
        }

        $sql = "SELECT $campos
                FROM user_stories us
                JOIN proyectos p ON p.id_backlog = us.id_backlog
                $relacion
                $WHERE
                ORDER BY us.id_user_storie ASC";
