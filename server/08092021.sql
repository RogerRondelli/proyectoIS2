...
MySQL - 10.4.17-MariaDB : Database - proyectois
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`proyectois` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/*Table structure for table `lineas_base` */

DROP TABLE IF EXISTS `lineas_base`;

CREATE TABLE `lineas_base` (
  `id_linea_base` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `lineas_base` */

insert  into `lineas_base`(`id_linea_base`,`nombre`,`estado`,`id_proyecto`,`fecha_registro`) values (1,'Linea base 1','Abierto',1,'2021-05-08 01:19:21'),(3,'Linea base 2','Abierto',3,'2021-05-08 22:08:19'),(4,'Prueba','Abierto',5,'2021-06-28 20:04:16');
...
insert  into `menus`(`id_menu`,`menu`,`submenu`,`titulo`,`url`,`orden`,`subsubmenu`,`estado`) values (3,'Modulo de Administracion','Roles','Roles','./administrar-roles.php',4,0,1),(4,'Modulo de Administracion','Accesos segun Roles','Accesos segun Roles','./menus-por-roles.php',5,0,1),(7,'Modulo de Administracion','Usuarios','Usuarios','./administrar-usuarios.php',8,0,1),(95,'Modulo de Desarrollo','Proyectos','Proyectos','./administrar-proyectos.php',9,0,1),(96,'Modulo de Desarrollo','Tareas','Tareas','./administrar-tareas.php',10,0,1),(97,'Modulo de Gestion de Configuracion','Lineas Base','Lineas Base','./administrar-lineasBase.php',12,0,1);
...
insert  into `proyectos`(`id_proyecto`,`nombre`,`estado`,`fecha_registro`) values (1,'Prueba','Abierto','2021-05-07 15:31:52'),(3,'Prueba 2','Abierto','2021-05-08 21:40:40'),(5,'Prueba 3','Abierto','2021-06-28 20:00:13');
...
CREATE TABLE `relaciones` (
  ...
  `id_linea_base` int(11) NOT NULL,
  `id_tarea` int(11) NOT NULL,
  PRIMARY KEY (`id_relacion`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4;

/*Data for the table `relaciones` */

insert  into `relaciones`(`id_relacion`,`id_linea_base`,`id_tarea`) values (4,1,1),(5,1,3),(7,3,6),(8,4,11);

/*Table structure for table `relaciones_tareas` */

DROP TABLE IF EXISTS `relaciones_tareas`;
...
/*Data for the table `relaciones_tareas` */

insert  into `relaciones_tareas`(`id_relacion`,`id_proyecto`,`id_tarea`) values (1,3,6),(2,3,7),(3,1,1),(4,1,2),(5,1,3),(6,1,4),(9,5,8),(10,0,9),(11,0,10),(12,5,11);
...
) ENGINE=InnoDB AUTO_INCREMENT=480 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `tareas` (
  ...
  `estado` enum('Iniciado','Pendiente','Finalizado') NOT NULL,
  `prioridad` varchar(200) NOT NULL,
  `descripcion` text NOT NULL,
  `observacion` text NOT NULL,
  `id_proyecto` int(11) NOT NULL,
  `id_tarea_padre` int(11) NOT NULL,
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
insert  into `tareas`(`id_tarea`,`nombre`,`version`,`estado`,`prioridad`,`descripcion`,`observacion`,`id_proyecto`,`id_tarea_padre`,`fecha_registro`) values (1,'Tarea 1','1','Iniciado','','asdsadasdds saSA','',1,0,'2021-05-08 21:24:46'),(2,'Tarea 2','2','Iniciado','','aaaaaaa','',1,1,'2021-06-28 15:26:58'),(3,'Tarea 3','1','Iniciado','','ssssssss','',1,2,'2021-05-08 21:24:47'),(4,'Tarea 4','1','Pendiente','alta','ssssss','realizar la tarea',1,3,'2021-06-28 15:12:53'),(6,'Tarea 1 - proyecto 2','1','Pendiente','baja','hola','hola',3,0,'2021-06-28 15:27:50'),(7,'Tarea 2 - proyecto 2','1','Iniciado','alta','realizar ','realizar con cuidado',3,6,'2021-06-28 15:29:23'),(8,'Prueba Tarea22','1','Pendiente','alta','prueba','prueba',5,0,'2021-06-28 20:01:10'),(9,'Prueba tarea 2','2','Iniciado','baja','prueba','prueba',0,0,'2021-06-28 20:01:59'),(10,'Prueba Tarea 2','1','Iniciado','1','prueba','',0,9,'2021-06-28 20:02:34'),(11,'Prueba Tarea 2','1','Iniciado','baja','prueba','prueba',5,8,'2021-06-28 20:03:03');
...
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Usuarios del sistema';

/*Data for the table `usuarios` */

insert  into `usuarios`(`id_usuario`,`nombre_usuario`,`nombre`,`apellido`,`password`,`fecha_registro`,`estado`,`rol`) values (1,'admin','admin','admin','202cb962ac59075b964b07152d234b70','2016-08-14 23:50:02',1,1),(174,'LM','Luis','Rojas','202cb962ac59075b964b07152d234b70','2019-12-07 12:28:57',1,1),(178,'robert','Robert','Perez','202cb962ac59075b964b07152d234b70','2019-12-08 19:55:18',1,4),(183,'rodrigo','Rodrigo','Rojas','202cb962ac59075b964b07152d234b70','2021-03-04 22:25:23',1,5),(186,'fabian','Fabian','Prieto','202cb962ac59075b964b07152d234b70','2021-05-08 22:25:48',1,6),(189,'lili','Lili ','Riveros','202cb962ac59075b964b07152d234b70','2021-06-28 19:55:47',1,25);
